...
#
# NEW: apply ALL card-quality fixes automatically:
...
#
# Outputs:
#   outputs/agentcard_attack/<model_tag>/<scenario>/def_<defense>/seed_<seed>/
#     *_clean.jsonl, *_attack.jsonl
#     *_clean_metrics.json, *_attack_metrics.json
#     card_pipeline_meta.json
...
def main():
    ...
    tasks = load_json(base / "tasks.json")[:20]
