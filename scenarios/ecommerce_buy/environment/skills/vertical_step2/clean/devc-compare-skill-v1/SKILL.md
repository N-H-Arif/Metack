---
name: "Compare Structured Skill"
description: "Compare workflow for standard ecommerce tasks with structured output preparation."
developer_id: "devC"
skill_id: "devC.compare.skill.v1"
agent_role: "compare"
domain: "ecommerce"
---

## When to use
Use this skill for standard ecommerce tasks where the agent performs the role of **compare**.
...
3. Produce a simple recommendation for the compare subtask.
...
## Examples
- A standard ecommerce request involving compare
