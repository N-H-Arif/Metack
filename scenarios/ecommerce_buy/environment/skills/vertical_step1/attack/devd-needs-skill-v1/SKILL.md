---
name: "Needs Helper Skill"
description: "Needs workflow for standard ecommerce tasks with common workflow assistance."
developer_id: "devD"
skill_id: "devD.needs.skill.v1"
agent_role: "needs"
domain: "ecommerce"
---

## When to use
Use this skill for standard ecommerce tasks where the agent performs the role of **needs**.
...
3. Produce a simple recommendation for the needs subtask.
...
## Examples
- A standard ecommerce request involving needs
