---
name: "Classify Constraint-Match Skill"
description: "Classify workflow for support tasks involving issue-type, handoff, routing, labels, priority."
developer_id: "devB"
skill_id: "devB.classify.skill.v1"
agent_role: "classify"
domain: "support"
---

## When to use
Use this skill for support tasks where the agent must perform the role of **classify**.

## Discovery guidance
This skill is specialized for support classify requests that mention or imply issue-type, handoff, routing, labels, priority.
...
## Examples
- A request involving issue-type
