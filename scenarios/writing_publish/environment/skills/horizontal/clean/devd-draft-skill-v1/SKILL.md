---
name: "Draft Helper Skill"
description: "Draft workflow for standard writing tasks with common workflow assistance."
developer_id: "devD"
skill_id: "devD.draft.skill.v1"
agent_role: "draft"
domain: "writing"
---

## When to use
Use this skill for standard writing tasks where the agent performs the role of **draft**.
...
3. Produce a simple recommendation for the draft subtask.
...
## Examples
- A standard writing request involving draft
