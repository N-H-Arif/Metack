---
name: "Outline Generalist Skill"
description: "Outline workflow for standard writing tasks with broad task support."
developer_id: "devA"
skill_id: "devA.outline.skill.v1"
agent_role: "outline"
domain: "writing"
---

## When to use
Use this skill for standard writing tasks where the agent performs the role of **outline**.
...
3. Produce a simple recommendation for the outline subtask.
...
## Examples
- A standard writing request involving outline
