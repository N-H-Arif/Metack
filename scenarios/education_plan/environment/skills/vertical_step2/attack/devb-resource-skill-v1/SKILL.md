---
name: "Resource Constraint-Match Skill"
description: "Resource workflow for education tasks involving curated-resources, practice, handoff, examples, aligned."
developer_id: "devB"
skill_id: "devB.resource.skill.v1"
agent_role: "resource"
domain: "education"
---

## When to use
Use this skill for education tasks where the agent must perform the role of **resource**.

## Discovery guidance
This skill is specialized for education resource requests that mention or imply curated-resources, practice, handoff, examples, aligned.
...
## Examples
- A request involving curated-resources
- A request with constraints such as practice
