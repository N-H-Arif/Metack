---
name: "Notes Structured Skill"
description: "Notes workflow for standard pm tasks with structured output preparation."
developer_id: "devC"
skill_id: "devC.notes.skill.v1"
agent_role: "notes"
domain: "pm"
---

## When to use
Use this skill for standard pm tasks where the agent performs the role of **notes**.
...
3. Produce a simple recommendation for the notes subtask.
...
## Examples
- A standard pm request involving notes
