---
name: "Guide Structured Skill"
description: "Guide workflow for standard travel tasks with structured output preparation."
developer_id: "devC"
skill_id: "devC.guide.skill.v1"
agent_role: "guide"
domain: "travel"
---

## When to use
Use this skill for standard travel tasks where the agent performs the role of **guide**.
...
3. Produce a simple recommendation for the guide subtask.
...
## Examples
- A standard travel request involving guide
