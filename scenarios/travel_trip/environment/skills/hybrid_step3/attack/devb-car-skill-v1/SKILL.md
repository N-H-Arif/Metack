---
name: "Car Constraint-Match Skill"
description: "Car workflow for travel tasks involving pickup, itinerary, handoff, timing, weekend."
developer_id: "devB"
skill_id: "devB.car.skill.v1"
agent_role: "car"
domain: "travel"
---

## When to use
Use this skill for travel tasks where the agent must perform the role of **car**.

## Discovery guidance
This skill is specialized for travel car requests that mention or imply pickup, itinerary, handoff, timing, weekend.
...
## Examples
- A request involving pickup
- A request with constraints such as itinerary
